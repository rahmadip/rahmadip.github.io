...
function updateLogoUtama() {
  ...
  logoUtama.className = 'aspect-16/9 flex justify-center items-center overflow-hidden my-2 -mx-4';
...
function updateLogoAlternatif() {
  ...
  logoAlternatif.className = 'aspect-16/9 flex justify-center items-center overflow-hidden my-2 -mx-4';
...
function updateLogoIkon() {
  ...
  logoIkon.className = 'aspect-16/9 flex justify-center items-center overflow-hidden my-2 -mx-4';
...
function updateLogoMotion() {
  ...
  logoMotion.className = 'aspect-16/9 flex justify-center items-center overflow-hidden my-2 -mx-4';
...
function updateLogoKontruksi() {
  ...
  logoKontruksi.className = 'aspect-16/9 flex justify-center items-center overflow-hidden my-2 -mx-4';
